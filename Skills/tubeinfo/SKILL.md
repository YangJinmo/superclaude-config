---
name: tubeinfo
description: TubeAlfred MCP 도구로 유튜브 영상의 채널정보(채널명/구독자/채널URL), 영상정보(제목/조회수/좋아요/댓글수/업로드일/길이/카테고리/설명), 챕터 타임라인, 전체 자막을 가져와 정리해서 보여준다. 사용자가 유튜브 영상 URL을 주면서 정보를 요약해달라거나, 영상 내용이나 자막을 알고 싶다고 하거나, "/tubeinfo"를 직접 언급하면 이 스킬을 사용한다.
---

# tubeinfo — TubeAlfred로 유튜브 영상 정보 요약
